  ...
  <div v-if="isVisible" class="intro-loader" aria-hidden="true">
    ...
    <div class="intro-title" :class="{ 'is-ready': isTitleReady }" ref="titleEl">
      <div class="title-row">
        ...
        <div class="title-charts-cont"><span ref="seg2">IJ</span></div>
        <div class="title-charts-cont"><span ref="seg3">A</span></div>
        <div class="title-charts-cont"><span ref="seg4">Y</span></div>
      </div>
    </div>
  </div>
</template>
...
.title-charts-cont span {
  ...
  line-height: 1;
  color: #E0AC69; /* Rose gold color to match logo */
  white-space: nowrap;
}
